...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      details.loadDetails()
      TextView1.Text = "<b>" & details.getTextNode(1, "name") & "</b><br />" & details.getTextNode(1, "street") & "<br />" _
                       & details.getTextNode(1, "city") & ", " & details.getTextNode(1, "state") & " " & details.getTextNode(1, "zip")
    End Sub
